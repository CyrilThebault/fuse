...
Instructions to compile the code provided in this repository and to run FUSE are provided in the [FUSE manual](https://ch-earth-fuse.readthedocs.io/en/develop/).
