MODULE model_defn
 ...
 public :: LIST_RFERR, LIST_ARCH1, LIST_ARCH2, LIST_QSURF, LIST_QPERC, LIST_ESOIL, LIST_QINTF, LIST_Q_TDH, LIST_SNOWM, LIST_INTRC
 ...
 INTEGER, PARAMETER :: NDEC = 10                          ! number of model decisions
 ...
 TYPE(SNAMES),DIMENSION(8)             :: CSTATE          ! (list of model states for SMODL)
