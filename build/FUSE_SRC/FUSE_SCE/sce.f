...
C  LOCAL ARRAYS
      ...
      DIMENSION XNSTD(16),BOUND(16),CRITER(10)
      DIMENSION DIST(2000),XI(16)
C
C
...
C  COMPUTE THE PARAMETER DISTANCE FROM THE INITIAL POPULATION
      CALL NORMDIST(NPT,NOPT,X,XI,DIST,BOUND)
C
...
C  END OF SUBROUTINE SCEUA
  ...
  500 FORMAT(//,'*** PRINT THE INITIAL POINT AND ITS CRITERION ',
     &       'VALUE ***')
  510 FORMAT(/,' CRITERION',16(2X,A4,2X),/1X,80(1H-))
  520 FORMAT(F8.3,17F8.3)
  600 FORMAT(//,1X,'*** PRINT THE RESULTS OF THE SCE SEARCH ***')
  610 FORMAT(/,1X,'LOOP',1X,'TRIALS',1X,'COMPLXS',1X,'BEST F',1X,
     &       'WORST F',1X,'PAR RNG',1X,16(2X,A4,2X))
  630 FORMAT(I5,1X,I5,3X,I5,3F8.3,17(F8.3))
  650 FORMAT(/,1X,'POPULATION AT LOOP ',I3,/,1X,22(1H-))
  660 FORMAT(F8.3,17(F8.3))
...
C
      DIMENSION WO(16),CE(16),SNEW(16),STEP(16)
C
