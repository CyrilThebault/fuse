...
I=I+1; XNAME(I)='raw_rmse   '; XDESC(I)='root-mean-squared-error of flow                    '; XUNIT(I)='mm/day       '
I=I+1; XNAME(I)='log_rmse   '; XDESC(I)='root-mean-squared-error of LOG flow                '; XUNIT(I)='mm/day       '
...
I=I+1; XNAME(I)='mae        '; XDESC(I)='mean absolute error                                '; XUNIT(I)='mm/day       '
...
I=I+1; XNAME(I)='numerx_rmse'; XDESC(I)='RMSE between exact and approximate solution        '; XUNIT(I)='mm/day       '
