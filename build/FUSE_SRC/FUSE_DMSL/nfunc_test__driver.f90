...
FNAME_NETCDF = TRIM(OUTPUT_PATH)//TRIM(MBASIN_ID)//'__'//TRIM(SMODL%MNAME)//'__'//&
               TRIM(NSOLUTION)//'-'//TRIM(FADAPTIVE)//'__'//&
               TRIM(TRUNC_ABS)//'-'//TRIM(TRUNC_REL)//'__'//&
               TRIM(TSTEP_LEN)//'__numfuncs.nc'
...
STOP
END PROGRAM NFUNC_TEST__DRIVER
